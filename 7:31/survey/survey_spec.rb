...
describe("The survery") do
  it "finds the right max" do
    survey = Survey.new()
    survey.get_rating(3)
    survey.get_rating(4)
    survey.get_rating(5)
    assert_equal survey.max, 5
  end
  it "finds the right min" do
    survey = Survey.new()
    survey.get_rating(3)
    survey.get_rating(4)
    survey.get_rating(5)
    assert_equal survey.min, 3
  end
  it "finds the right average" do
    survey = Survey.new()
    survey.get_rating(3)
    survey.get_rating(4)
    survey.get_rating(5)
    assert_equal survey.average, 4
  end
